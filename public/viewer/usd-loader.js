...
export async function loadUsdStage(args) {
    ...
    if (!postDrawBridgeWarmupSummary
        ...
        && typeof window.renderInterface.startRobotMetadataWarmupForStage === "function") {
        void Promise.resolve(window.renderInterface.startRobotMetadataWarmupForStage({ force: false })).catch(() => {
