...
declare type HdWebSyncDriver = {
    ...
    GetRobotMetadataSnapshot?: (linkPaths: ArrayLike<string>, stageSourcePath?: string) => {
        stageSourcePath?: string | null,
        generatedAtMs?: number,
        source?: string,
        linkParentPairs?: ArrayLike<[string, string | null]>,
        jointCatalogEntries?: ArrayLike<{
            linkPath?: string,
            jointPath?: string,
            jointName?: string,
            jointType?: string,
            ...
            axisToken?: string,
            axisLocal?: ArrayLike<number>,
            lowerLimitDeg?: number,
            upperLimitDeg?: number,
            localPivotInLink?: ArrayLike<number> | null,
            [key: string]: unknown,
        }>,
        linkDynamicsEntries?: ArrayLike<{
            linkPath?: string,
            mass?: number | null,
            centerOfMassLocal?: ArrayLike<number>,
            diagonalInertia?: ArrayLike<number> | null,
            principalAxesLocal?: ArrayLike<number>,
            [key: string]: unknown,
        }>,
        [key: string]: unknown,
    },
    GetPrimTransforms: () => { world?: Record<string, ArrayLike<number>>, local?: Record<string, ArrayLike<number>>, count?: number },
    SetPreferProtoBlobOverHydraPayload?: (prefer: boolean) => void,
    GetPreferProtoBlobOverHydraPayload?: () => boolean,
